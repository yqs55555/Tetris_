...
BEGIN_MESSAGE_MAP(CTetrisDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_BEGINGAME, &CTetrisDlg::OnBnClickedButtonBegingame)
	ON_BN_CLICKED(IDC_BUTTON_HELP, &CTetrisDlg::OnBnClickedButtonHelp)
	ON_BN_CLICKED(IDC_BUTTON_EXIT, &CTetrisDlg::OnBnClickedButtonExit)
